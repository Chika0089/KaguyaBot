...
ptt: false, seconds: 0,contextInfo: {
 ...
 mediaUrl: 'www.instagram.com/Rendyrasya8',
    mediaType: 2, 
    description: 'www.instagram.com/Rendyrasya8',
    title: "Now Playing...",
    body: wm,
    thumbnail: await (await fetch('https://telegra.ph/file/150c8d5e9990a5cfad8fe.jpg')).buffer(),
    sourceUrl: 'www.instagram.com/Rendyrasya8'
 	  /*   sourceUrl: sig,
           title: '◄⟬ ●━━━ ⧏ ⧎ ⧐ ━━━● ⟭►',  
            body: 'Now Playing...', 
           thumbnail: await (await fetch('https://telegra.ph/file/150c8d5e9990a5cfad8fe.jpg')).buffer()*/
